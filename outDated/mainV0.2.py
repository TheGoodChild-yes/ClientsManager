...
class ElementPlacer :
    ...
    def get_element_details(self, is_button) :
        ...
        def on_submit() :
            ...
            popup.destroy()
            command = self.get_command(command_name) if is_button else None
            popup.result = (name, command)
    ...
    def save_layout(self) :
        ...
        for element, command in self.elements :
    ...
    def load_layout(self) :
        ...
        if file_path :
            ...
            for elem in layout :
                ...
                y = elem["y"] * height
                widget.place(x=x, y=y)
                self.elements.append((widget, command))
